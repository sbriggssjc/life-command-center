-- lcc_my_day: add owner-scoped Active Deals (bd_opportunities, ranked by proximity to
-- close) and Next Best Touchpoints (touchpoint_cadence, tier-ranked, due/overdue, stale
-- >400d dropped). APPLIED LIVE 2026-07-31 via MCP. Replaces the 3-arg version.
drop function if exists public.lcc_my_day(uuid, integer, integer);
