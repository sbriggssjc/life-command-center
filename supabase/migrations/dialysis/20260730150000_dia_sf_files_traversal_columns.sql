...
--
-- Mirror of the government migration. The SF → LCC file-discovery sweep is being
-- extended from Comp__c only to Listing__c and Opportunity (Deal)
-- ContentDocumentLinks. These convenience columns stamp which comp / listing /
-- deal SF id a discovered file belongs to so the om-comp-resolver traversal
