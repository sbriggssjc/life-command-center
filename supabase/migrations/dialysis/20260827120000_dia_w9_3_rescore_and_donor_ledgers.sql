-- ============================================================================
-- W9.3 (dia) — reversible ledgers for the SF-link re-score (WS2) + donor
-- handoff (WS3). Applied live to dia (zqzrriwuavgrquhisnoa).
--
...
--   UPDATE public.true_owners t SET sf_company_id = NULL
