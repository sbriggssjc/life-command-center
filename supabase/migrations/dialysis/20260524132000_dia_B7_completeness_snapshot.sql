-- ============================================================================
-- 20260524132000_dia_B7_completeness_snapshot.sql
-- OWNERSHIP_AND_SALES_REMEDIATION_PLAN — B7 extension (dia)
--
-- Extends the nightly B7 worker to also snapshot v_sales_completeness_summary
-- and open a 'completeness_regression' alert when the avg score drops >1.5
-- points vs the prior snapshot.
-- ============================================================================
...
BEGIN
  ...
  -- New rule: completeness_regression — avg sale-completeness score drop >1.5 pts
