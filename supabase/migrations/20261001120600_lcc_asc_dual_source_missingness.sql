-- Advance a frozen ASC candidate only after the operator explicitly attests
-- that exact-property searches in both licensed sources returned no match.
-- This is a review disposition, never a fabricated evidence capture.
