-- ============================================================================
-- Round 76au — gov cron health monitor (companion to dia + LCC versions)
--
-- Same pattern as dia 76au — appends failed cron job runs into
-- lcc_health_alerts with auto-resolve on subsequent success.
--
