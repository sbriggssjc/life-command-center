-- ============================================================================
-- Gov — reconcile listing history CHECKs + expose exclude flag on the
...
-- Gov mirror of the dia file of the same date. See the dia header for the
-- rationale. Gov columns differ (listing_status, asking_price, source_url /
-- tracked_urls jsonb, tenant_agency); the reconcile + appended column match.
-- ============================================================================
