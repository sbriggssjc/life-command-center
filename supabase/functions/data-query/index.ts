...
const GOV_READ_TABLES = new Set([
  ...
  "loans", "sales_transactions", "recorded_owners", "true_owners",
  "v_sales_comps", "v_available_listings",
...
const GOV_WRITE_TABLES = new Set([
  "properties", "prospect_leads", "ownership_history", "contacts",
  "recorded_owners", "true_owners", "sales_transactions", "loans",
...
const DIA_READ_TABLES = new Set([
  ...
  "contacts", "sales_transactions", "sale_brokers", "brokers", "loans",
