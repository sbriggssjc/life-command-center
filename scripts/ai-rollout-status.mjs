...
console.log(`- Checklist: ${path.resolve(process.cwd(), 'docs/architecture/ai-chat-routing/AI_CHAT_ROLLOUT_CHECKLIST.md')}`);
console.log(`- Results template: ${path.resolve(process.cwd(), 'docs/architecture/ai-chat-routing/AI_CHAT_ROLLOUT_RESULTS_TEMPLATE.md')}`);
console.log(`- Worklog: ${path.resolve(process.cwd(), 'docs/architecture/ai-chat-routing/LCC_AI_COST_AND_CHATBOT_REVIEW.md')}`);
