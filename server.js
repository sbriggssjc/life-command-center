...
app.all('/api/discovery-queue', (req, res) => { req.query._route = 'discovery-queue'; actionsHandler(req, res); });
app.all('/api/janitor-rules', (req, res) => { req.query._route = 'janitor-rules'; actionsHandler(req, res); });
...
app.all('/api/webhooks/todo-completion-poll', (req, res) => { req.query._route = 'todo-completion-poll'; syncHandler(req, res); });
...
app.all('/api/copilot/intelligence/:action', (req, res) => { req.query._route = 'chat'; req.query._copilot_path = req.params.action; operationsHandler(req, res); });
