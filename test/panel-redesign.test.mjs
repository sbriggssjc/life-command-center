...
describe('§1.1 STRUCTURAL — panel widths are var-driven and the shell is coherent', () => {
  ...
  it('REGRESSION: cache busters moved together on every file this change touched', () => {
    ...
    const versions = { 'app.js': v('app.js'), 'app-modal.js': v('app-modal.js'), 'app-treasury-chart.js': v('app-treasury-chart.js'), 'app-export-comps.js': v('app-export-comps.js'), 'detail.js': v('detail.js'), 'detail-rent.js': v('detail-rent.js'), 'detail-panel-shell.js': v('detail-panel-shell.js'), 'detail-entity-tabs.js': v('detail-entity-tabs.js'), 'detail-openers.js': v('detail-openers.js'), 'detail-tab-documents.js': v('detail-tab-documents.js'), 'ops.js': v('ops.js'), 'styles.css': v('styles.css') };
