...
def _credit_values(cr: dict, t: dict):
    ...
    lf = {
        ...
        # Facility-level reconciled economics (dialysis deals; from tenants[0].credit.recon_*)
        "Clinic Revenue — Reconciled (FY)": g("recon_clinic_revenue"),
        "Clinic Operating Profit — Reconciled": g("recon_clinic_op_profit"),
        "Clinic EBITDA — Reconciled": g("recon_clinic_ebitda"),
        "Clinic EBITDA Margin": g("recon_clinic_ebitda_margin"),
        "Operating Margin": g("recon_op_margin"),
        "Rent Coverage (EBITDAR / Rent)": g("recon_rent_coverage"),
        "Reconciled Fiscal Year": g("recon_fiscal_year"),
        "Data Confidence": g("recon_confidence"),
