"""BOV v2 — Tab 3: Real Estate Fundamentals (Leg 1).
...
def build_real_estate_tab(wb):
    ...
    c = ws.cell(row=r, column=2,
                value="Leg 1 of 3  ·  Physical property, location, and market fundamentals  ·  Short-form summary at top  ·  Full diligence matrix below")
