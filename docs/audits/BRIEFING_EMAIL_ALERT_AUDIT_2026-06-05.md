> 🚨 **SUPERSEDED/STALE (DOCMAP3, 2026-09-24; moved from `docs/BRIEFING_EMAIL_ALERT_AUDIT_2026-06-05.md`):** 2026-06-05 evidence. The two old briefing flows it deleted (`90fbb308`, `6ec55229`) stay deleted, and the live flow is `briefing-morning-email-v2` in `docs/os/FLOW-REGISTRY.yaml` (spec `docs/architecture/flows/BRIEFING_EMAIL_FLOW_v2.md`). The §6 watch plan is complete.
...
`docs/architecture/flows/BRIEFING_EMAIL_FLOW_v2.md`) is the intended replacement; the May 19 flow
