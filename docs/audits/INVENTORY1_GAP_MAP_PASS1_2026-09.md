# INVENTORY1 — Pass 1: Intent Inventory & Gap Map (2026-09-16)

> **Archived verbatim.** This is pass 1's original content, preserved unchanged (filename
> shifted from `INVENTORY1_GAP_MAP_2026-09.md`, which is now the **consolidated** doc folding
> pass 1 + pass 2 + INVENTORY1b's items 4–6 together — read
> [`INVENTORY1_GAP_MAP_2026-09.md`](INVENTORY1_GAP_MAP_2026-09.md) first). Kept here so every
> number and caveat in the original pass survives in full, citable by its own anchors.
>
