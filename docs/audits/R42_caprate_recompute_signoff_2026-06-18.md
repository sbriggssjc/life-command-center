> 🚨 **SUPERSEDED/STALE (DOCMAP3, 2026-09-24; moved from `docs/R42_caprate_recompute_signoff_2026-06-18.md`):** the Status line is wrong: the scoped backfill was APPLIED live 2026-06-18 (gov run `r42_backfill_20260618144329`, dia `r42_backfill_20260618144401`). The review queue it seeded is a June snapshot that was never re-run; see PLANNED-BACKLOG `UX-T1c-caprate-rerun`.
