> 🚨 **SUPERSEDED/STALE (DOCMAP3, 2026-09-24; moved from `docs/CONTACTS_SPLIT_BRAIN_DELTA_2026-07-21.md`):** pre-cutover snapshot. LCC Opps became canonical via `CONTACTS_HUB=ops` on 2026-08-17, and gov `unified_contacts` now has RLS on with no anon grants (measured 2026-09-24). See root `CLAUDE.md` "unified_contacts LIVES IN TWO PROJECTS" and backlog `CONTACTS-GOV-WRITER`.
