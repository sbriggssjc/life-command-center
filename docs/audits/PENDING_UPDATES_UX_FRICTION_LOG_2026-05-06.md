> 🚨 **SUPERSEDED/STALE (DOCMAP3, 2026-09-24; moved from `docs/PENDING_UPDATES_UX_FRICTION_LOG.md`):** queue counts (544) and `gov.js` line numbers are from 2026-05-06, and Tier 1 items #1–#7 have shipped. The open Tier 2/3 ideas are filed as backlog `DOCMAP3-govlinkpick`. Re-measure `pending_updates` before quoting.
