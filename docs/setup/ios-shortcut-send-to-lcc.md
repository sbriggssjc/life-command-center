> 🚨 **SUPERSEDED/STALE (DOCMAP3, 2026-09-24; moved from `docs/ios-shortcut-send-to-lcc.md`):** "Set Vercel env vars" is obsolete: env lives on Railway (Vercel retired 2026-07-20, torn down 2026-09-18). Staged shares in `intake_share_inbox` have no review UI yet (backlog `DOCMAP3-shareinbox`).
