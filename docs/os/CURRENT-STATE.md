...
| **Document capture / OCR / deeds** (read this, not the five older files) | **`docs/architecture/document-capture-ocr-and-deeds.md`** — ✅ **DOC1 + DOC8/9/10 shipped; DOC12 closed.** Drain 695 → **604**, `bov_ready` **13**, **zero gpt-4o escalations**, deeds 325/325. ⚠️ **The cap raise unlocks zero leases — the 16–30 band holds ONE document corpus-wide; the MARKER closed the escalation.** 🟢 **DOC14 staged and sized: over-cap is 100% LEASES at 8.1% (7 today, ~36 projected), 31–57 pages — the full executed leases BOV extract reads.** ⚠️ Quote 8.1%, not the page-counted 32% (wrong denominator, ~4× over). 🔵 **DOC13 time-gated to 2026-09-02 ~16:30 UTC, NOT run.** ⛔ Do NOT widen cron 160 (DOC7). |
