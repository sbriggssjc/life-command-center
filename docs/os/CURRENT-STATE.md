...
The daily brief's **Analyst's Take** is now generated on the GaryBuilt box. **Measured 2026-08-26:
`briefing_intel_snapshot` for today carries a 774-char take with `analyst_take_meta.source =
'onprem_ollama'`; 2026-08-25 and every prior day are length 0.** First real on-box narrative.
