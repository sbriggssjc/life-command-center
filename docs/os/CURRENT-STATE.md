...
| **Document capture / OCR / deeds** (read this, not the five older files) | **`docs/architecture/document-capture-ocr-and-deeds.md`** — ✅ **DOC1 + DOC8/9/10 shipped, deployed and VERIFIED 2026-09-01.** CRE drain reaches id 2 (undrained 695 → 678); **0 rows covered-and-thin — the DOC10 defect is closed**; `bov_ready` 5; deeds 325/325. 🔴 **DOC12 — DOC8's 30-page cap is deployed but UNEXERCISED** (the 16–30 page band has had zero OCR events; the *"30 got 40"* observation was on v23). ⛔ Do NOT widen cron 160 (DOC7). |
