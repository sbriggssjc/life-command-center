...
- 🟡 **F2. Extract the approved ASC rules into a lane-neutral pure matcher and de-identified golden corpus.** Include building designators, candidate-scoped legal/operating-name aliases, same-parcel service-location/mailing-address conflicts, and three-token multi-address parcels pinned to a source record and observed operating tenant; no fuzzy matching or canonical promotion.
