...
| **EXT2-spotcheck** | **Open the Chesterbrook Champaign lease** (`PROPERTIES\C\Chesterbrook Academy\Champaign, IL\Rec'd\Chesterbrook - Champaign, IL (Lease).pdf`, 25 pp): does the rent schedule state **$8,464/mo** as "Rent" (base $7,445 + equipment $1,019)? Then decide: for BOV `year1_rent`, do we take the lease's schedule figure (**current behaviour**, $101,568/yr) or its defined "Base Rent" ($89,340/yr, equipment carried separately)? One sentence back settles EXT2a's edge. |
