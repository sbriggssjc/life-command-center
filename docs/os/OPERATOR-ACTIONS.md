...
| **EXT2** | **Define year-1 base rent and "the tenant" for BOV extract** (backlog EXT2). The extractor now quotes faithfully; what it cannot decide is policy: does base rent exclude separately-stated equipment/additional rent (doc 255: $7,445 + $1,019 = $8,464)? Is year 1 the first schedule period? Is the tenant the registered entity with DBA/co-tenants carried beside? One answer each; then a resolver. |
