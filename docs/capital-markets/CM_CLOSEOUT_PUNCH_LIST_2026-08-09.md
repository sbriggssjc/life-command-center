> 🚨 **SUPERSEDED/STALE (DOCMAP3, 2026-09-24; moved from `docs/CM_CLOSEOUT_PUNCH_LIST_2026-08-09.md`):** 2026-08-09 round note. Its post-redeploy steps (Q2-2026 re-freeze, 4-book visual check) are not tracked here. Confirm the packet and export state in `docs/capital-markets/` and CURRENT-STATE before re-running them.
