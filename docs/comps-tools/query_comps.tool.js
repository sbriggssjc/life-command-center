...
// sales-lane dedup ranks on. Tiebreaker only when confidence ties (e.g. dia_db
// comps all carry confidence 0.85). Defensive: absent -> neutral (no behavior
// change). Mirror of mcp/comps-tools.js priceQuality.
