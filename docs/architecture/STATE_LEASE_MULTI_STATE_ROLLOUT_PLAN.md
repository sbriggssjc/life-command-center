> 🚨 **SUPERSEDED/STALE (DOCMAP3, 2026-09-24; moved from `docs/STATE_LEASE_MULTI_STATE_ROLLOUT_PLAN.md`):** TX auto-fetch is BUILT (government-lease `state-lease-ingest.yml`, monthly) and the producer restarted (617 events through 2026-08-05). FL/WA/PA/MN/CO adapters exist as PENDING field maps; see government-lease `CLAUDE.md` §21/§27. The "no scheduler / remaining Phase-2 build" text is obsolete. government-lease owns this pipeline.
...
> **Companion docs:** `docs/audits/STATE_GOV_LEASE_GAP_MEMO_2026-06-23.md` (the origin story, Topics 1–3,
