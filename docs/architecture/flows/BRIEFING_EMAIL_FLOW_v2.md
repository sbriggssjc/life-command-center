> 🚨 **SUPERSEDED/STALE (DOCMAP3, 2026-09-24; moved from `docs/BRIEFING_EMAIL_FLOW_v2.md`):** every "Vercel" reference is wrong. The render endpoint is the Railway host (`server.js` `/api/briefing-email`), and env vars live in Railway. Vercel was retired 2026-07-20 and torn down 2026-09-18. The live flow's export is registered in `docs/os/FLOW-REGISTRY.yaml` (`briefing-morning-email-v2`, trigger 12:30 UTC).
