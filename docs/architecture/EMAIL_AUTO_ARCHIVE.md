> 🚨 **SUPERSEDED/STALE (DOCMAP3, 2026-09-24; moved from `docs/EMAIL_AUTO_ARCHIVE.md`):** the mover/stamp-back described in §3b/§5a was replaced by the P120 Move-Queue Executor (`api/_handlers/move-queue.js`, `v_lcc_move_queue_worklist`, `lcc_move_queue_ack`) plus P119/P121 semantics (`already_out` terminal, `staged_at` anchor, `lcc_todo_completion_mark_filed`). Read `docs/architecture/flows/move-queue-executor.md` and root `CLAUDE.md` P119/P121 first.
