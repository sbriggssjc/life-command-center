> 🚨 **SUPERSEDED/STALE (DOCMAP3, 2026-09-24; moved from `docs/INFRA_ALERT_CLASSIFICATION.md`):** Vercel was retired 2026-07-20 (torn down 2026-09-18), so only GitHub alerts are live inputs. The custom "Flag → To Do" PA flow was retired 2026-07-21 in favour of the native Flagged-email list, so the `todo_title` hand-off has no consumer.
