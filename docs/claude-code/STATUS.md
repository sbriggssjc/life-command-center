...
| **App feedback intake (SBN)** | FLOWS1, FLOWS1-artifact, FLOWS-consolidate, FLOWS-consolidate-lcc, FLOWS1-path, HOME1, HOME2, PRI1, PRI2, PRI2-on, DIA1, DIA1b, DIA1c, ID3a-drift, RECON1, RECON1-b, RECON2, RECON2-b, RECON2-render, RECON3, RECON3-b, SIDEBAR3, SIDEBAR3-b, SIDEBAR3-c, SIDEBAR3-d, EXT-HOST-2, SIDEBAR4, LEASEJUNK1, PERF-SPQ2, HOME2-fix, HOME2-b, HOME2-c, HOME2-d, HOME2-e, PERF-SPQ1, PERF-SPQ1-b, PERF-SPQ1-c, RECON2-c, RECON2-d, RECON2-d-reconcile, RECON2-d-render, RESOLVER1, SIDEBAR-LEASE1, SIDEBAR2, DIA-PROPAGATOR1, VERCEL-LIVE1, GOV-AVAIL1, GOV-UX1, SIDEBAR4-b, SIDEBAR4-c, RECON2-render-spa, RECON2-render-dossier, SIDEBAR3-d-orient, GOV-UX1-D1, GOV-UX1-D2, GOV-UX1-D3, GOV-UX1-D4, GOV-UX1-D5, GOV-UX1-D4-sftype, GOV-UX1-D5-gate, GOV-AVAIL1-postoak, GOV-AVAIL1-agency-tail, GOV-AVAIL1-twins, GOV-AVAIL1-govtype, GOV-AVAIL1-civic-drift, RECON2-render-views, HOME-MB-BOOT, SIDEBAR4-d, INTAKE-RESTAGE1, GOV-UX1-D1-registry, SF-BRIDGE1, SIDEBAR5, GOV-COMPS-CAP, GOV-UX1-D5-gate-bank, GOV-UX1-D5-gate-buyerspe, GOV-UX1-D5-gate-sponsor, SF-BRIDGE1-flow, GOV-CLASSIFY1, GOV-CU1, GOV-AVAIL2, SF-BRIDGE1-suppress, GOV-COMPS-SCOPE-reason, SIDEBAR5-residue | 2026-09-23 | **Current (round 70, 2026-09-23):** `tranquil-delight` live on `9c994171`; MCP redeployed; `data-query` v46; extension 1.0.58 in `main`. SBN-1…29 triaged. **Closed and live today:** GOV-CU1 (DB live: Available 490→473, 33 lender properties archived, NCUA kept; JS on next redeploy; edge deploy pending), SIDEBAR5 (header-only subject address, gov 41083 corrected, status polling, header-junk tenants), GOV-COMPS-CAP (4,849 comps load), GOV-UX1-D5-gate-2 (15 lane cards, ~67% projected), SF-BRIDGE1 (Findlay end to end + deal addresses where staged), plus rounds 63–69. **Prompted, waiting on CC:** `GOV-CLASSIFY1` (no_domain on properties already in gov: Jellico TN DHS, Tulelake ranger station), `GOV-AVAIL2` (display case + agency tail). **Waiting on Scott:** Q51/Q55 (grade the 15 lane cards; reload 1.0.58 + a Contacts-tab Save; check the comps pill), Q54 (the SF Deal sync flow edit — exact steps written). **Filed, not prompted:** SF-BRIDGE1-suppress, SIDEBAR5-residue, GOV-COMPS-SCOPE-reason, SIDEBAR5-twin-lane-consumer, GOV-UX1-D1-registry, GOV-AVAIL1 follow-ups, RECON2-render-views, SIDEBAR4-b, SIDEBAR3-b, SIDEBAR3-d-orient, FLOWS1 SF Listing spike. Older narrative: [`docs/history/STATUS_open-threads_SBN-row_to_2026-09-22.md`](../history/STATUS_open-threads_SBN-row_to_2026-09-22.md) + dated entries below. |
| **App feedback intake (SBN)** | FLOWS1, FLOWS1-artifact, FLOWS-consolidate, FLOWS-consolidate-lcc, FLOWS1-path, HOME1, HOME2, PRI1, PRI2, PRI2-on, DIA1, DIA1b, DIA1c, ID3a-drift, RECON1, RECON1-b, RECON2, RECON2-b, RECON2-render, RECON3, RECON3-b, SIDEBAR3, SIDEBAR3-b, SIDEBAR3-c, SIDEBAR3-d, EXT-HOST-2, SIDEBAR4, LEASEJUNK1, PERF-SPQ2, HOME2-fix, HOME2-b, HOME2-c, HOME2-d, HOME2-e, PERF-SPQ1, PERF-SPQ1-b, PERF-SPQ1-c, RECON2-c, RECON2-d, RECON2-d-reconcile, RECON2-d-render, RESOLVER1, SIDEBAR-LEASE1, SIDEBAR2, DIA-PROPAGATOR1, VERCEL-LIVE1, GOV-AVAIL1, GOV-UX1, SIDEBAR4-b, SIDEBAR4-c, RECON2-render-spa, RECON2-render-dossier, SIDEBAR3-d-orient, GOV-UX1-D1, GOV-UX1-D2, GOV-UX1-D3, GOV-UX1-D4, GOV-UX1-D5, GOV-UX1-D4-sftype, GOV-UX1-D5-gate, GOV-AVAIL1-postoak, GOV-AVAIL1-agency-tail, GOV-AVAIL1-twins, GOV-AVAIL1-govtype, GOV-AVAIL1-civic-drift, RECON2-render-views, HOME-MB-BOOT, SIDEBAR4-d, INTAKE-RESTAGE1, GOV-UX1-D1-registry, SF-BRIDGE1, SIDEBAR5, GOV-COMPS-CAP, GOV-UX1-D5-gate-bank, GOV-UX1-D5-gate-buyerspe, GOV-UX1-D5-gate-sponsor, SF-BRIDGE1-flow | 2026-09-23 | **Current (round 69, 2026-09-23):** `tranquil-delight` live on `ec1d81df`. **Closed and live today:** GOV-UX1-D5-gate (lane + precision meter + auto-create, flag OFF), SF-BRIDGE1 (deal types; seeded OM matching; **Findlay listing 15286 live on dia 51194**), plus rounds 63–68. **Prompted, waiting on CC:** `SIDEBAR5` (Contacts-tab address captured as the property, stuck "still processing", header junk as tenants), `GOV-UX1-D5-gate-2` (bank / SPE sibling / sponsor collapse before Scott grades). **Waiting on Scott:** Q51 (grade the lane after gate-2), Q52 (redeploy the MCP service for the SF deal-address sync), Q53 (Salesforce cleanups + export the SF Deal sync flow). **Filed, not prompted:** SF-BRIDGE1-flow, GOV-UX1-D1-registry, GOV-AVAIL1 follow-ups, RECON2-render-views, SIDEBAR4-b, SIDEBAR3-b, SIDEBAR3-d-orient, FLOWS1 SF Listing spike (SBN-18). Older narrative: [`docs/history/STATUS_open-threads_SBN-row_to_2026-09-22.md`](../history/STATUS_open-threads_SBN-row_to_2026-09-22.md) + dated entries below. |
