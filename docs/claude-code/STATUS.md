...
| **App feedback intake (SBN)** | FLOWS1, FLOWS1-artifact, FLOWS-consolidate, FLOWS-consolidate-lcc, FLOWS1-path, HOME1, HOME2, PRI1, PRI2, PRI2-on, DIA1, DIA1b, DIA1c, ID3a-drift, RECON1, RECON1-b, RECON2, RECON2-b, RECON2-render, RECON3, RECON3-b, SIDEBAR3, SIDEBAR3-b, SIDEBAR3-c, SIDEBAR3-d, EXT-HOST-2, SIDEBAR4, LEASEJUNK1, PERF-SPQ2, HOME2-fix, HOME2-b, HOME2-c, HOME2-d, HOME2-e, PERF-SPQ1, PERF-SPQ1-b, PERF-SPQ1-c, RECON2-c, RECON2-d, RECON2-d-reconcile, RECON2-d-render, RESOLVER1, SIDEBAR-LEASE1, SIDEBAR2, DIA-PROPAGATOR1, VERCEL-LIVE1, GOV-AVAIL1, GOV-UX1, SIDEBAR4-b, SIDEBAR4-c, RECON2-render-spa, RECON2-render-dossier, SIDEBAR3-d-orient, GOV-UX1-D1, GOV-UX1-D2, GOV-UX1-D3, GOV-UX1-D4, GOV-UX1-D5, GOV-UX1-D4-sftype, GOV-UX1-D5-gate, GOV-AVAIL1-postoak, GOV-AVAIL1-agency-tail, GOV-AVAIL1-twins, GOV-AVAIL1-govtype, GOV-AVAIL1-civic-drift, RECON2-render-views, HOME-MB-BOOT, SIDEBAR4-d, INTAKE-RESTAGE1, GOV-UX1-D1-registry, SF-BRIDGE1 | 2026-09-23 | **Current (round 68, 2026-09-23):** `tranquil-delight` live on `2967920a`; `intake-salesforce-files` v31; extension 1.0.57 live (one run per Save, verified). **Closed today:** SIDEBAR4-c/-d, HOME-MB-BOOT, INTAKE-RESTAGE1 (both halves), GOV-UX1-D1–D4, plus rounds 63–66. **Prompted, waiting on CC:** `GOV-UX1-D5-gate` (Q48 hybrid: tight gate → one-click review lane → auto-create at ≥90% precision over 25 decisions) and `SF-BRIDGE1` (SF deals: type NULL, no address, OMs can't follow the Salesforce seed; Findlay end to end). **Waiting on Scott:** Q50 (Wichita Falls: the capture was 4005 Call Field Rd, not 2600 Central E Fwy). **Filed, not prompted:** GOV-UX1-D1-registry, GOV-AVAIL1 follow-ups (twins now include Wichita Falls 31048/31796), RECON2-render-views, SIDEBAR4-b, SIDEBAR3-b, SIDEBAR3-d-orient, FLOWS1 SF Listing spike (SBN-18). Older narrative: [`docs/history/STATUS_open-threads_SBN-row_to_2026-09-22.md`](../history/STATUS_open-threads_SBN-row_to_2026-09-22.md) + dated entries below. |
