...
|---|---|---|---|
| **Identity / operator canonicalization (ID-series)** | ID0–ID4, ID2a-cleanup, ID2b, ID2b-caps, ID2b-caps-2, ID3a–ID3e, ID3a-d, ID3d-reconcile, ID3d-b | 2026-09-16 | ID2b-caps-2 + ID3a–e live; **ID3d live and its record now in this repo** (#2539; Dialysis #7416 removal = D3); ID3d-b filed (81 guarantor strings / 87 leases to review) |
