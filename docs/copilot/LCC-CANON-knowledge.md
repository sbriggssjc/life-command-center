# LCC-CANON — Team Briggs operating rules

Authoritative behavioral rules for the LCC Deal Agent: HOW to format and behave (comps discipline, resolution, filing, email routing, logging, offer submission, writing voice, BOV, intake, personal). This file is RULES ONLY — never a data source. Comps come only from SynthesizeComps/QueryComps/GenerateComps, never from this file; never paste rows or numbers from here.
