> 🚨 **SUPERSEDED/STALE (DOCMAP3, 2026-09-24; moved from `SPEC_BOV_Lease_Extractor_Unit4_BUILD.md`):** built. The DocAI Custom-Extractor misconfig was fixed 2026-08-12 (Enterprise OCR processor; root `CLAUDE.md` OCR section), the sync cap is now 30 pages with DOC18 windowing, and `vercel.json` no longer exists. Truth: `docs/architecture/document-capture-ocr-and-deeds.md`.
