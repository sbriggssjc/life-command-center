> 🚨 **SUPERSEDED/STALE (DOCMAP3, 2026-09-24; moved from `docs/LCC_OM_Ingestion_Surfaces_2026-04-21.md`):** the "Stage to LCC" sidebar button described as "not deployed yet" has shipped (`extension/sidepanel.js` `.doc-stage-btn`, `background.js` `FETCH_PDF_AS_BASE64`). Sidebar page captures do NOT go through `stageOmIntake`. The live channel map is `docs/architecture/om_intake_pipeline.md`.
