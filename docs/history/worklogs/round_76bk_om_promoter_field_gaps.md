> 🚨 **SUPERSEDED/STALE (DOCMAP3, 2026-09-24; moved from `docs/round_76bk_om_promoter_field_gaps.md`):** "dia promoter doesn't write responsibilities" is no longer true (`intake-promoter.js` writes the `*_responsibility` fields). The pending-audit list here is largely done.
