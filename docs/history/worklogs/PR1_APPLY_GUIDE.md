> 🚨 **SUPERSEDED/STALE (DOCMAP3, 2026-09-24; moved from `docs/PR1_APPLY_GUIDE.md`):** the patch was applied to `gov.js`, and PR #2 (the `renderGovGsaLinkReview` link-review body) has also shipped. Do not re-apply.

# PR #1 — Pending Updates UX, Tier 1 — apply guide

This branch carries the first round of Pending Updates UX fixes drawn
from `docs/audits/PENDING_UPDATES_UX_FRICTION_LOG_2026-05-06.md`. It comes in two pieces:
...
2. **`docs/history/worklogs/PR1_pending_updates_ux.patch`** — a 226-line unified diff
...
git pull
git apply --check docs/history/worklogs/PR1_pending_updates_ux.patch
git apply docs/history/worklogs/PR1_pending_updates_ux.patch
git add gov.js
...
See docs/PR1_APPLY_GUIDE.md and docs/audits/PENDING_UPDATES_UX_FRICTION_LOG_2026-05-06.md."
git push
```
