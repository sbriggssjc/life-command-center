> 🚨 **SUPERSEDED/STALE (DOCMAP3, 2026-09-24; moved from `docs/BD_ENGINE_POST_WORK_AUDIT_2026-05-22.md`):** May-2026 snapshot: the sync crons are live, band definitions and counts have moved (UX-T1a), and production is Railway. Current state is `docs/architecture/bd-ranking-and-priority-queue.md` + `docs/os/CURRENT-STATE.md`.
