> 🚨 **SUPERSEDED/STALE (DOCMAP3, 2026-09-24; moved from `docs/RAILWAY_DEPLOYMENT.md`):** the Vercel→Railway cutover finished 2026-07-20 and Vercel was torn down 2026-09-18. `server.js` on Railway is the single `/api` router (healthcheck `/health`, deploy gate `npm run verify:deploy`); see `docs/architecture/infrastructure-topology.md` and root `CLAUDE.md`.
