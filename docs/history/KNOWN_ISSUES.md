> 🚨 **SUPERSEDED/STALE (DOCMAP3, 2026-09-24; moved from `docs/KNOWN_ISSUES.md`):** entry 1 is tracked as backlog `PR5a` (the "31" count has moved; re-measure `v_field_provenance_unranked`). Entry 2 is resolved (P120). New known issues go in `docs/os/PLANNED-BACKLOG.md`, not here.
