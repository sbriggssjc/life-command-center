> 🚨 **SUPERSEDED/STALE (DOCMAP3, 2026-09-24; moved from `SPEC_BOV_Lease_Extractor_Unit4.md`):** built. OCR and doc-text truth is `docs/architecture/document-capture-ocr-and-deeds.md`.
...
> **Build notes:** see `docs/history/SPEC_BOV_Lease_Extractor_Unit4_BUILD.md` for exactly what
