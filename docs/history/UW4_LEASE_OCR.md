> 🚨 **SUPERSEDED/STALE (DOCMAP3, 2026-09-24; moved from `docs/UW4_LEASE_OCR.md`):** deeds are no longer on direct gpt-4o (OCR2 made tiered OCR the default and refuses `ocrTiered=false`). DocAI sync is 30 pages from page 1 since DOC8 (15 off page 1, windowed longdoc route per DOC18); see `docs/architecture/document-capture-ocr-and-deeds.md`.
