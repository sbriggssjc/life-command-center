> 🚨 **SUPERSEDED/STALE (DOCMAP3, 2026-09-24; moved from `docs/LCC_Copilot_Bidirectional_Plan_2026-04-21.md`):** Stages A and C shipped, and the Copilot "Receive OM" attachment topic was abandoned 2026-04-21. Production runs on Railway (`server.js`), not Vercel, and there is no 12-function cap. Current intake truth is `docs/architecture/om_intake_pipeline.md`.
