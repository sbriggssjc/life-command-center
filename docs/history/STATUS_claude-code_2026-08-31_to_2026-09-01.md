# STATUS archive — Claude Code queue, 2026-08-31 → 2026-09-01 (CMS restart, DOC1–DOC18, C13/C14, N-series block)

> **Moved verbatim from `docs/claude-code/STATUS.md` on 2026-09-08** (CONSOLIDATE2; the file was 8,975
> lines against the ~8,000 rule). This is the contiguous block that sat at lines 4741–8975: the
> 2026-08-31 CMS-ingestion-outage restart (B6d-cms-step, D1, the throttle/DSN fixes), the document
> pipeline arc (DOC1 → DOC18, OCR windowing, longdoc), the entity-role arc (C13/C13b/C13c/C14), and
> the trailing archive-pointer notes for two earlier cuts (2026-08-20 → 2026-08-28, 2026-08-20 →
> 2026-08-21) that had been sitting at the tail of the file. ⚠️ `STATUS.md` is NOT strictly
> date-sorted (two windows append to it) — this block was chosen as a contiguous span by line number,
> not a date range; every heading in it is dated 2026-08-31 or 2026-09-01, with no later-dated entry
> found anywhere below the cut point.
>
> **Nothing was dropped.** Every still-open item named in this span (B6b-lead, B6c-orphan, C19, N14,
> N15b, N15g, N16, DOC1/8/9/12, PR5d, PR8, C13f/g/h, B6e-fred-verify, B6e-ci-mask-ruff, B6d-sam,
> B6b-june, and the rest) was already carried into `docs/os/PLANNED-BACKLOG.md` before this cut —
> confirmed by name, not assumed. Where an entry here disagrees with a canonical page (e.g.
> `docs/architecture/document-capture-ocr-and-deeds.md`, `docs/architecture/owner-role-classification.md`,
> `docs/architecture/producer-health-and-ci-enforcement.md`), **the page wins.**
