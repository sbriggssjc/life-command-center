> 🚨 **SUPERSEDED/STALE (DOCMAP3, 2026-09-24; moved from `docs/RUNBOOK_sf_opportunity_inbound_flow.md`):** "amounts will not land" is false for deals: the SF Deal → LCC Opportunity Sync flow maps `Opportunity.Amount` into `bd_opportunities.amount` (`mcp/opportunity-sync.js`). Only Task-based BD pursuits lack a value. See `docs/setup/SF-DEAL-SYNC-FLOW-EDIT-2026-09-23.md`.
