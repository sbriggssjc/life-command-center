...
**Date:** 2026-05-05 (recon) · 2026-05-06 (Tier 1 + Tier 2 macro-pair) · 2026-05-07 (Tier 2 fully complete) · 2026-05-08 (gov-side `cm_gov_market_share_pie` Phase-1-gap closed)
**Owner:** Scott Briggs
**Status:** Tier 1 + Tier 2 fully done. **All 8 dialysis chart_template_ids now have working views + applies_to_verticals.** Gov-side market_share_pie also live (Phase-1 silent-404 gap closed). Remaining work: Tier 3 (about-Northmarq) + Tier 4 (editorial CMS).
