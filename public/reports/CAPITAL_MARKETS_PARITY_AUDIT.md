...
**Date:** 2026-05-05 (recon) · 2026-05-06 (Tier 1 + Tier 2 macro-pair shipped) · 2026-05-07 (Tier 2 fully complete — 8 of 8 dialysis charts shipped)
**Owner:** Scott Briggs
**Status:** Tier 1 + Tier 2 fully done. **All 8 dialysis chart_template_ids now have working views + applies_to_verticals.** Remaining work: gov-side `cm_gov_market_share_pie` (silent 404 since Phase 1; not yet built) + Tier 3 (about-Northmarq) + Tier 4 (editorial CMS).
